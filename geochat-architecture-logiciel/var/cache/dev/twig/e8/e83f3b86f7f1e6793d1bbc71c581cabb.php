...
class __TwigTemplate_fb3e23589762a95f58d0c644f1c8a33b extends Template
{
    private $source;
    private $macros = [];
...
{% macro render_bus_messages(messages, showBus = false) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/messenger.html.twig", "/home/maximlyoen/Bureau/CoursIutInfo/geochat-architecture-logiciel/vendor/symfony/web-profiler-bundle/Resources/views/Collector/messenger.html.twig");
    }
}

...
class __TwigTemplate_ee14d4640db4bfdf5aee351ae32fd442 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        // line 4
        $_trait_0 = $this->loadTemplate("message/_widgets.html.twig", "message/edit.html.twig", 4);
        if (!$_trait_0->isTraitable()) {
            throw new RuntimeError('Template "'."message/_widgets.html.twig".'" cannot be used as a trait.', 4, $this->source);
        }
...
";
    ...
    {
        return array (  107 => 11,  103 => 9,  93 => 8,  74 => 6,  63 => 1,  61 => 3,  48 => 1,  28 => 4,);
    }
...
{% use 'message/_widgets.html.twig' %}

{% block title %}Éditer un message{% endblock %}

{% block body %}
    <h2>Éditer un message</h2>

    {{ include('message/_form.html.twig') }}

{% endblock %}
", "message/edit.html.twig", "/home/maximlyoen/Bureau/CoursIutInfo/geochat-architecture-logiciel/templates/message/edit.html.twig");
    }
}

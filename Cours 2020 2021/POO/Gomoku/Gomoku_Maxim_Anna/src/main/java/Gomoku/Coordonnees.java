...
class Coordonnees {
     ...
     * NE PAS MODIFIER.
     */
    static final int NB_LIGNES = 20;
    /**
     * Nombre de colonnes du plateau.
     * NE PAS MODIFIER.
     */
    static final int NB_COLONNES = 20;
    ...
    /**
     * Détermine si on se situe dans le plateau
     * 
     * @return vrai si on est à l'intérieur du plateau
     * 
     * @author Félix Chabellard
     */
    boolean estDansPlateau() {
        return (0 <= ligne &&  ligne < NB_LIGNES) && (0 <= colonne && colonne < NB_LIGNES);
    }
    ...
    /**
     * Convertit un nom de colonnes (par exemple 'C') en numéro de colonne (ici 2).
     *
